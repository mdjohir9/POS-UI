...
export class commonTaskService {
  ...
  private GET_UNIT_INFO: string;
  private GET_CATEGORY_INFO: string;
  private GET_BRAND_INFO: string;
  constructor(private genericHttpService: GenericHttpService<any>) {
    ...
    this.GET_UNIT_INFO = `api/POSUnit/units?companyId=${this.companyId}`;
    this.GET_CATEGORY_INFO = `api/POSCategory/categories?companyId=${this.companyId}`;
    this.GET_BRAND_INFO = `api/POSBrand/brands?companyId=${this.companyId}`;
  }
  ...
  getUnits(): Observable<any> {
    return this.genericHttpService.getAll<any>(this.GET_UNIT_INFO).pipe(
      map((response: any) => {
  ...
  getCategorys(): Observable<any> {
    return this.genericHttpService.getAll<any>(this.GET_CATEGORY_INFO).pipe(
      map((response: any) => {
  ...
  getBrands(): Observable<any> {
    return this.genericHttpService.getAll<any>(this.GET_BRAND_INFO).pipe(
      map((response: any) => {
