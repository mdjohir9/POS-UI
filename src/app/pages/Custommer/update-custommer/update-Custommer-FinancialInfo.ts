...
@Component({
  selector: 'update-custommer-financialInfo',
  template: `
...
export class UpdateCustommerFinancialInfoComponent {
  ...
  ngOnInit(): void {
   ...
   this.getFinancialInfo(); // Fetch financial info after form initialization
  }
  ...
  getFinancialInfo(): void {
    this.route.paramMap.subscribe(params => {
      ...
      console.log('Fetching Financial Info for Customer ID:', customerId);
