...
@Component({
  selector: 'update-custommer-contact',
  template: `
<div>
...
export class UpdateCustommerContactComponent {
  ...
  ngOnInit(): void {
    ...
    // Call API after form initialization
...
getContactInfo(): void {
  this.route.paramMap.subscribe(params => {
    const customerId = params.get('id'); // Get customer ID from route
